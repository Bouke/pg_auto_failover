...
typedef enum ReplicationState
{
	...
	REPLICATION_STATE_REPORT_LSN = 14,
	REPLICATION_STATE_FAST_FORWARD = 15,
	REPLICATION_STATE_WAIT_FORWARD = 16,
	REPLICATION_STATE_WAIT_CASCADE = 17,
	REPLICATION_STATE_UNKNOWN = 18
} ReplicationState;
